...
export class ActivateComponent implements OnInit {
  ...
  submitCode() {
    ...
    return this.http.post<any>(
        this.baseUrl + '/users/activate', {code: this.values, userId});
  }

  newCode() {
    // console.log('er,oa123123');
    let userId = localStorage.getItem('userId');
    return this.http.post<any>(this.baseUrl + '/v2/users/sendcode', {userId});
  }
      ...
      this.submitCode().subscribe(
          res => {
            ...
            if (res.success == false) {
              ...
              this.notifier.notify('error', '!کد شما نا درست است');
            } else {
